    ...
    return (
        <>
            ...
            <div className='w-screen h-14 shadow-purple-500 shadow-md flex flex-row justify-center items-center'>
                <div className='w-[40%] flex justify-start items-center font-bold text-purple-500'>
                    Max store
                </div>
                <div className='w-[40%] flex justify-start items-center'>
                    ...
                    <div className='w-full flex flex-row justify-end items-center gap-8 font-bold'>
